...
class RetroEffectImpl extends Effect {
  constructor(options: { colorNum?: number; pixelSize?: number } = {}) {
    const { colorNum = 4.0, pixelSize = 2.0 } = options;
    const uniforms = new Map<string, THREE.Uniform<THREE.Vector2 | number>>([
...
function RetroEffect(props: { colorNum?: number; pixelSize?: number }) {
  const { colorNum = 4.0, pixelSize = 2.0 } = props;
  return <WrappedRetro colorNum={colorNum} pixelSize={pixelSize} />;
}
